...
describe('[Challenge] Free Rider', function () {
  ...
  it('Execution', async function () {
    ...
    const AttackFreeRider = await ethers.getContractFactory('AttackFreeRider', attacker);
    this.attackerContract = await AttackFreeRider.deploy(
      this.weth.address,
    ...
    await this.attackerContract.attack(this.weth.address, NFT_PRICE);
  });
