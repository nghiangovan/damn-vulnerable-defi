...
describe('[Challenge] Naive receiver', function () {
  ...
  it('Execution', async function () {
    ...
    const AttackNativeReceiver = await ethers.getContractFactory('AttackNativeReceiver', deployer);
    this.attacker = await AttackNativeReceiver.deploy(this.pool.address);
